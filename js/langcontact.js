function changeLanguage(language) {
  ...
  if (language === 'zh') {
    ...
    page5.innerHTML = '联系我们';
    part1.innerHTML = '询价';
    part2.innerHTML = '有关项目或任何询价的问题，请发送电子邮件与我们联系。';
    part3.innerHTML = '媒体联系';
    part4.innerHTML = '有关业务的问题、项目信息或者与经理交谈，请致电杨先生。';
    ...
    page5.innerHTML = 'Contact'
    part1.innerHTML = 'Inquiries'
    part2.innerHTML = 'For any and all questions concering a project or any inquiery, please just drop us an email.'
    part3.innerHTML = 'Press Related'
    part4.innerHTML = 'For all business-related questions, project information or to speak to a representative, please call Mr. Yang.'
    ...
    page5.innerHTML = 'お問い合わせ';
    part1.innerHTML = 'お問い合わせ';
    part2.innerHTML = 'プロジェクトに関する質問やお問い合わせについては、どうぞメールでお気軽にお問い合わせください。';
    part3.innerHTML = 'プレス関連';
    part4.innerHTML = 'ビジネスに関する質問やプロジェクト情報、担当者と話すには、お電話で Mr. Yang までお問い合わせください。';
