...
function changeLanguage(language) {
  ...
  if (language === 'zh') {
    ...
    type2.innerHTML = '汽车零部件'
    type3.innerHTML = '医疗零部件'
    type4.innerHTML = '电器'
    ...
    type2.innerHTML = 'Automotive Parts'
    ...
    type2.innerHTML = '自動車部品'; // Automotive Parts的日语翻译
    type3.innerHTML = '医療部品'; // Medical Parts的日语翻译
